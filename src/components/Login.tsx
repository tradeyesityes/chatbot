            ...
            <div className="bg-white/80 backdrop-blur-xl p-8 rounded-3xl shadow-2xl w-full max-w-md border border-white/50">
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-3xl font-black text-slate-800">
                        {showOtpInput ? 'تفعيل الحساب' : (isSignUp ? 'إنشاء حساب' : 'تسجيل الدخول')}
                    </h2>
                    <p className="text-slate-500 mt-2 font-medium">
                        {showOtpInput ? 'أدخل الكود المرسل لبريدك الإلكتروني' : (isSignUp ? 'أنشئ حسابك للبدء' : 'مرحباً بعودتك!')}
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    >
                        {loading ? 'جاري المعالجة...' : (showOtpInput ? 'تفعيل الحساب' : (isSignUp ? 'إنشاء حساب' : 'دخول'))}
                    </button>
                </form>
