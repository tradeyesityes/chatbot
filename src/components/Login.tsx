                            ...
                            <>
                                ...
                                <div className="flex flex-col gap-4 mb-6">
                                    <button
                                        ...
                                        className="flex items-center justify-center gap-2 py-3 border border-slate-100 rounded-xl font-bold text-sm hover:bg-slate-50 transition-all active:scale-95 w-full"
                                    >
